  ...
  return (
    <div className="bg-gray-950 text-gray-300 min-h-screen">
      ...
      <header className="relative bg-gradient-to-r from-gray-950 to-black text-gray-100 ">
        <div className="container  md:max-w-[95vw] mx-auto flex flex-col md:flex-row items-center justify-between  px-6 py-16 ">
          {/* Hero Content */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {isLoading ? (
            ...
            featuredLaptops.map((laptop, index) => (
              <div
                key={index}
                className="w-full bg-gray-900 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform"
              >
                {/* Image */}
                <img
                  src={laptop.imageUrl}
